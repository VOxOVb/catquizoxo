const behaviorQ = [
  {
    ...
    parse:
      "貓貓喜歡溫暖的地方，電腦運作時會產生熱量，因此貓貓會喜歡躺在電腦上。此外，貓貓也喜歡主人的注意力，當主人在使用電腦時，貓貓可能會躺在電腦上以引起主人的注意。",
  },
  {
    tag: "behavior",
    question: "喵星人比較喜歡女生...",
    ...
    parse:
      "貓貓在潛意識中認為聲音高的人通常身形小，而這代表著「安全」，因為女性的聲音通常比較高，所以貓貓比較容易親近女性。 ",
  },
  {
    tag: "behavior",
    question: "喵星人喜歡玩紙箱...",
    ...
    parse:
      "貓貓喜歡有遮蔽的地方，紙箱可以提供他們躲藏，富有安全感。此外，因為紙箱的材質帶來的磨爪回饋，也深受多數喵星人喜愛。",
  },
  {
    tag: "behavior",
    question: "喵星人飛機耳...",
  ...
  },
  {
    ...
    parse:
      "當喵喵的尾巴快速擺動的時候，就不要再逗貓咪啦！這時候貓咪心情煩躁，尾巴正說著「我在生氣，別惹我！」如果搞不清楚貓咪的身體語言，還以為貓咪是像狗狗一樣在「搖尾巴」的話，可就免不了挨上幾爪了喔",
  },
  {
    tag: "behavior",
    question: "喵星人露出水汪汪大眼...",
...
const foodQ = [
  {
    ...
    parse:
      "貓罐頭加水「會不會稀釋營養價值」？貓罐頭中的營養成分非常充足，加水只會變得濕潤，對貓貓的營養攝取並不會產生影響，且可以幫助貓貓補充水分，減輕鈉含量負擔，可謂一舉數得！",
  },
  {
    tag: "food",
    question: "喵星人吃巧克力...",
    ...
    parse:
      "巧克力含有對貓貓有毒的物質「可可鹼」，即使只是少量，也可能導致貓貓中毒，嚴重時甚至可能危及生命。因此，絕對不要讓貓貓吃巧克力。",
  },
  {
    tag: "food",
    question: "喵星人喝牛奶...",
    ...
    parse:
      "雖然貓貓可能會喜歡牛奶的味道，但是為了避免腸道不適，建議不要給貓貓喝牛奶，或淺嘗即可，食用後若出現症狀可能就代表貓貓乳糖不耐喔！",
  },
];
...
const itemQ = [
  {
    ...
    parse:
      "貓貓追逐雷射筆光點需要全神貫注，長期使用下來對眼睛有一定的損傷（地板或牆壁反光都有可能照到眼睛）；且雷射光點總是讓牠們抓不到，久而久之會產生一種挫折感。如果家裡貓貓對真的逗貓棒沒有興趣，建議先選擇弱光性的雷射筆，且在引起他興趣的時候切換回實體逗貓棒（可以碰觸的玩具），避免挫折感。如果貓貓真的只喜歡雷射筆，也盡量在他抓到光點時給牠一點零食獎勵。",
  },
  {
    tag: "item",
    question: "喵星人對於貓薄荷...",
    ...
    parse:
      "貓貓對貓薄荷會表現出興奮、愉快的行為。但也有一部分的貓貓對貓薄荷沒有反應，這是因為對貓薄荷反應的基因是隨機遺傳的，也有可能隨著年紀增加而逐漸對貓薄荷失去興趣，所以如果家中貓貓不領情，貓奴們也不用太訝異或傷心啦～。",
  },
  {
    tag: "item",
    question: "喵星人對於貓草...",
    ...
    parse:
      "貓草其實不是一種草!是泛指可以促進貓貓腸胃蠕動、幫助排除腸道內毛球的植物，富含植物纖維、維生素及礦物質等營養成分，市面上常見貓草有小麥草、大麥草、燕麥草等等。野外貓貓沒有化毛膏、排毛粉可以吃，就是靠這些貓草排出體內的毛球，有些腸胃不適的貓貓吃貓草也能減輕症狀喔～",
  },
  {
    tag: "item",
    question: "喵星人的廁所...",
    ...
    parse:
      "貓貓在如廁時會感到脆弱，所以貓砂盆應該放在安靜且隱蔽的地方，讓貓貓感到安全。",
  },
  {
    tag: "item",
    question: "喵星人洗澡...",
    ...
    parse:
      "貓貓自己會用舔舐身體達到清潔效果，除非在特殊情況下（例如貓貓身上沾染了有毒物質），否則通常不需要人為幫助貓貓洗澡。",
  },
  {
    tag: "item",
    question: "幫喵星人穿衣服...",
    ...
    parse:
      "大部分的貓貓並不喜歡穿衣服，因為這會限制他們的活動。如果貓貓有皮膚病的情況下，可以給醫生評估是否給貓貓穿衣服。",
  },
  //   {
  //     tag: "item",
  //     question: "抓喵星人前腳抱抱...",
  ...
  //     ],
  //     parse:
  //       "每隻貓貓的性格都不同，有的貓貓喜歡被抱抱，有的則不喜歡。最重要的是要尊重貓貓的意願，不要強迫貓貓做他不喜歡的事情。",
  //   },
  {
    tag: "item",
    question: "幫喵星人剪指甲...",
    ...
    parse:
      "貓貓的指甲會不斷生長，如果不定期剪指甲，可能會導致指甲過長刺入肉裡，造成疼痛和感染。所以貓貓需要定期剪指甲。",
  },
];
